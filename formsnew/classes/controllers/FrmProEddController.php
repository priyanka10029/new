...
<div id="pro_cred_form" class="frm_grid_container <?php echo esc_attr( $authorized ? '' : 'frm_unauthorized_box' ); ?>">
	...
	<p class="frm9 frm_form_field frm-license-input">
		<input type="text" name="proplug-license" value="<?php echo esc_attr( $value ); ?>" placeholder="<?php echo esc_attr( $placeholder ); ?>" id="edd_<?php echo esc_attr( $this->plugin_slug ); ?>_license_key" />
